<div class="invoices index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('pay_reference'); ?></th>
	...
	<tr>
		...
		<td>
			...
			<!-- <?php echo $this->Html->link($invoice['Customer']['lastname'], array('controller' => 'customers', 'action' => 'view', $invoice['Customer']['id'])); ?> -->
		...
		<td><?php echo h($invoice['Invoice']['pay_reference']); ?>&nbsp;</td>
		<td><?php echo h($invoice['Invoice']['statu_id']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Customers'), array('controller' => 'customers', 'action' => 'index')); ?> 
		</li>
